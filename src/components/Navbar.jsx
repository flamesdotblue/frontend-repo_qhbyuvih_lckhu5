    ...
    <header className="w-full sticky top-0 z-10 backdrop-blur bg-white/70 border-b border-slate-200">
      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-blue-600 text-white grid place-items-center font-bold">🎬</div>
          <div>
            <h1 className="text-xl font-semibold text-slate-900">Movie Share</h1>
            <p className="text-xs text-slate-500 leading-none">Watch and share from anywhere</p>
          </div>
        </div>
        <button
